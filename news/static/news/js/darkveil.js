...
vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    ...
    buf[1] = mat4(
        ...
        vec4(3.310376, 8.209261, 1.135539, -1.165539)
    ) * buf[6] + mat4(
...
class DarkVeil {
    ...
    init() {
        ...
        try {
            ...
            // Инициализация с цветами для темной темы по умолчанию
            this.program = new Program(gl, {
                ...
                uniforms: {
                    ...
                    uWaveColor: { value: new Vec3(1, 1, 1) },    // Белые волны
                    uBgColor: { value: new Vec3(0.05, 0.07, 0.09) } // Темный фон
                }
            });
    ...
    updateColors() {
        ...
        if (isDarkTheme) {
            // Темная тема: темный фон, белые волны
            this.program.uniforms.uBgColor.value.set(0.05, 0.07, 0.09); // #0d1117
            this.program.uniforms.uWaveColor.value.set(1, 1, 1);       // #ffffff
        } else {
            // Светлая тема: белый фон, темные волны
            this.program.uniforms.uBgColor.value.set(1, 1, 1);         // #ffffff
            this.program.uniforms.uWaveColor.value.set(0.05, 0.07, 0.09); // #0d1117
        }
    }
    ...
    loop() {
        ...
        this.program.uniforms.uTime.value = (performance.now() - this.startTime) / 1000;
    ...
    destroy() {
        ...
        document.removeEventListener('themeChanged', this.updateColors.bind(this));
    }
}

// Инициализация при загрузке и принудительное обновление темы
document.addEventListener('DOMContentLoaded', () => {
    window.darkVeil = new DarkVeil();
    
    // Принудительно отправляем событие themeChanged при загрузке
    setTimeout(() => {
